                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-wrap gap-3 mb-12">
                            <button
                                ...
                                className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${activeCategory === "all"
                            ...
                            {faqs.map((category) => (
                                <button
                                    ...
                                    className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${activeCategory === category.category
                                            ? "bg-primary-500 text-white shadow-brand"
                                            : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                        }`}
                                >
